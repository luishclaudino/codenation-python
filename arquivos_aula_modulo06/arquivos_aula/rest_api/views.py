...
from rest_framework import mixins # para misturar classes
from rest_framework import generics #classes de view genéricas
...
class CategoryListOnlyAPIView(mixins.ListModelMixin, generics.GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        # pode adicionar uma validação neste ponto
